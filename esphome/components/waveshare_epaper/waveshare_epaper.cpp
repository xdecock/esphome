...
void WaveshareEPaper7P5InV2GrayScale::send_lut_base() {
  uint8_t lut_vcom_7_i_n5_v2[] = {
      0x0, 0xF, 0xF, 0x0, 0x0, 0x1, 0x0, 0xF, 0x1, 0xF, 0x1, 0x2, 0x0, 0xF, 0xF, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0,
      0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
  };
  ...
  // VCOM
  this->transmit_lut(0x20, lut_vcom_7_i_n5_v2, 42);

  // LUT WW
  this->transmit_lut(0x21, lut_ww_7_i_n5_v2, 42);

  // LUT BW
  this->transmit_lut(0x22, lut_bw_7_i_n5_v2, 42);

  // LUT WB
  this->transmit_lut(0x23, lut_wb_7_i_n5_v2, 42);

  // LUT BB
  this->transmit_lut(0x24, lut_bb_7_i_n5_v2, 42);
}
