...
WaveshareEPaper7P5InV2GrayScale = waveshare_epaper_ns.class_(
    "WaveshareEPaper7P5InV2GrayScale", WaveshareEPaper
)
...
MODELS = {
    ...
    "7.50in-bv2gray": ("b", WaveshareEPaper7P5InV2GrayScale),
